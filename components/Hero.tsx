      ...
      {isClient && (
        <div className="absolute inset-0 overflow-hidden">
          {[...Array(6)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-1.5 h-1.5 bg-primary-400 rounded-full opacity-30"
              initial={{
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-gray-300 mb-12 max-w-xl mx-auto leading-relaxed"
          >
